...
const JobCard = ({ title, type }: JobCardProps) => (
  <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b py-4 px-6">
    <div>
      ...
      <p className="text-sm text-[#000000]">{type}</p>
    </div>
    ...
    <MainLayout>
      <section className="bg-[#FEFAEF] pt-16 mb-16">
        ...
        <div className="bg-[#FFFFFF] h-auto md:h-[350px] grid items-center mt-16 ">
          <Container>
            <div className=" grid md:grid-cols-2 justify-center mx-auto mt-16 gap-8">
              <h2 className="text-[49px] max-w-[476px] font-medium">Do you have what it takes to join us</h2>
              <p className="text-black font-normal text-[16px]  items-center py-6">
                At Jolojolo, our people are our greatest asset. We’re building more than a business; we’re building a
                team that’s kind, curious, and driven to make life easier for others. We care about skills, but we care
                even more about attitude. If you love solving problems, working with people, and growing fast, you’ll
                fit right in.
              </p>
            </div>
          </Container>
